...
('Printer','Electornics',9500.50,5,'2024-02-01',7.50),
...
-- Total Quantity of Electronics products above 20000 price
SELECT SUM(quantity) AS Elec_quantity
FROM products
...
-- Average Price of products with condititon
